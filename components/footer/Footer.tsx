...
function Footer() {
  return (
    <footer className="self-stretch rounded-xl bg-[#269DA3] overflow-hidden flex flex-row items-start justify-between py-[1.75rem] px-[1.5rem] gap-[1.25rem] text-left text-[1.563rem] text-white font-poppins mq450:flex-wrap">
