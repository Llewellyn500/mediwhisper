...
function Footer() {
  return (
    <footer className="self-stretch bg-[#269DA3] overflow-hidden flex flex-row items-start justify-between py-[1.75rem] px-[1.5rem] gap-[1.25rem] z-[2] text-left text-[1.563rem] text-white font-poppins mq450:flex-wrap">
