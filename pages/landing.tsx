...
export default function LandingPage() {
  return (
    <><main className="py-20 pl-40">
          <h1 className="text-6xl font-bold mb-8 text-left text-black">Whispers Of</h1>
          ...
          <Image src="/heart2.webp" alt="Heart" width={700} height={10} priority className="absolute right-0" />
